...
use crate::config::types::{RabbitMQConfig, ServerConfig};
...
impl Server {
    ...
    pub async fn register_message_handler(
        ...
        self.rabbitmq_broker
            .register_handler(queue_name, routing_key, handler)
            .await
    ...
    pub async fn start_consuming(
        ...
        self.rabbitmq_broker
            .start_consuming(queue_name, exchange_name, routing_key)
            .await
            .map_err(ServerError::Broker)?;
